...
def arg_parser():
    ...
    parser.add_argument('--data_dir', type=str, default=r"E:\DZY\WGNN-DTA-main\Davis\Alignment\Complex", help='Path to the data directory containing all proteins(PDB) and ligands (SDF)')
    parser.add_argument('--esm_checkpoint', default='t6', type=str, help="Which checkpoint of ESM should be used [t6, t12, t30, t33]")
    parser.add_argument('--save_dir', type=str, default=r"E:\DZY\WGNN-DTA-main\Davis\ESM2",
...
if checkpoint=='t6': 
    model_name = ".\esm2_t6_8M_UR50D" #"facebook/esm2_t6_8M_UR50D"
...
for protein in tqdm(proteins):
    ...
    save_filepath = os.path.join(save_dir, f'{id}_{model_descriptor}.pt')
