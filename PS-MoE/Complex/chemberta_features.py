...
def arg_parser():
    ...
    parser.add_argument('--data_dir', type=str, default=r".\Complex", help='Path to the data directory containing all ligands (SDF files)')
    ...
    parser.add_argument('--save_dir', type=str, default=r".\Davis\ChemBERTa",
...
model_name = "E:\\DZY\\GEMS-main\\ChemBERTa-77M-MLM"
...
for compl in tqdm(complexes):
    ...
    for i, smiles in enumerate(smiles_list):
        ...
        save_filepath = os.path.join(save_dir, f"{id}_{model_descriptor.replace('-', '_')}_L{i+1:05}.pt")
