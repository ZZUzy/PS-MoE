...
def main():
    ...
    parser.add_argument("--data_dir", default=r".\Davis\Alignment\Complex", help="The path to the folder containing all Data() objects (graphs) of the dataset.")
    parser.add_argument('--save_path', default=r".\Davis\Alignment\Davis.pt", type=str, help='Path to save the dataset ending with .pt')
    
    # EMBEDDINGS TO BE INCLUDED
    parser.add_argument('--protein_embeddings', nargs='+', default=["ankh_base","esm2_t6"], help='Provide string to identify protein embeddings that should be incorporated (--protein embeddings string1 string2 string3).\
                        The strings should correspond to the keys that are used to save the embeddings in the graph object of the complexes'),
    parser.add_argument('--ligand_embeddings', nargs='+', default=["ChemBERTa_77M"], help='Provide names of embeddings that should be incorporated (--ligand_embeddings string1 string2 string3).\
                        The strings should correspond to the keys that are used to save the embeddings in the graph object of the complexes'),
