...
import sys
import os
from utils import convert_csv_to_json  # Ensure proper import
...
def main():
    ...
    parser.add_argument('--data_dir', type=str, default= r".\Complex",
                        help='Directory for input and output data')
    parser.add_argument('--save_dir', type=str, default= r".\Alignment",
                        help='Directory for input and output data')
    parser.add_argument('--y_data', type=str, default= r".\Davis_data_dict.json",
