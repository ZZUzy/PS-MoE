...
def arg_parser():
    ...
    parser.add_argument('--save_dir', type=str, default=r".\Davis\Ahkn",
...
if model_name == 'ankh_base':
    model_path = "E:\\DZY\\GEMS-main\\ankh-base"
...
for protein in tqdm(proteins):
    ...
    save_filepath = os.path.join(save_dir, f'{id}_{model_name}.pt')
